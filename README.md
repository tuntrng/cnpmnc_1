...
-> Vì ID là khóa chính, mà khóa chính thì không được trùng nhau, hay còn nói là phải độc nhất (unique). Nên nếu chèn entity có trùng ID thì Database sẽ báo lỗi ngay lập tức do việc đó đã vi phạm tính độc nhất của khóa chính.
